      ...
      >
        <div>
          ...
          <p style={{ color: "var(--muted)", margin: "6px 0 0", fontSize: 14 }}>
            Start a new Title Search Report for a client application
          </p>
        </div>
        <span
          style={{
          ...
          >
            <div>
              ...
              <select
                ...
                style={inp}
              >
                {["Narayan", "Priya Kulkarni", "Arun Patil", "Rohan Sane"].map(
                  (a) => (
          ...
          >
            ...
            <div>
              ...
              <input
                ...
                style={{
                  ...inp,
                  borderColor: errors.applicant ? "#dc2626" : "var(--border)",
                }}
              />
              {errors.applicant && (
                <span
                  ...
                  >
                    ...
                    <td style={{ padding: "14px 16px" }}>
                      <div style={{ display: "flex", gap: 6 }}>
                        ...
                        <button
                          onClick={() =>
                            setRecords((p) => p.filter((x) => x._id !== r._id))
                          }
                          style={{
                            background: "#fee2e2",
                            border: "none",
